...
NO=1.1.1.6;   W=1; S=3; E=; SC=;  BD='Ensure mounting of udf filesystems is disabled'
...
NO=1.1.18;    W=1; S=3; E=; SC=;  BD='Ensure /home partition includes the nodev option'
...
NO=5.3.21;    W=1; S=3; E=; SC=;  BD='Ensure SSH MaxStartups is configured'
